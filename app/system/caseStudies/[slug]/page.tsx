      ...
      <main className="flex-grow mt-16">
        <article className="max-w-4xl mx-auto py-12 px-4">
          <header className="mb-12">
            <h1 
              className="text-5xl font-bold mb-4 text-gray-800 bg-clip-text"
            >
              {post.title}
            </h1>
            <div 
              ...
              <PortableText
                ...
                components={{
                  block: {
                    ...
                    h2: ({ children }) => (
                      <>
                        ...
                        ></div>
                        <h2 
                          className="text-3xl font-bold mt-12 mb-6 text-gray-800 bg-gradient-to-r bg-clip-text text-transparent"
                        >
                          {children}
                        </h2>
                      </>
                  ...
                  list: {
                    ...
                    number: ({ children }) => (
                      <ol 
                        className="list-decimal pl-6 mb-6 text-gray-700"
                      >
                        {children}
                      </ol>
                    ),
                  ...
                  listItem: {
                    bullet: ({ children }) => (
                      <li 
                        className="mb-2 hover:text-blue-600 transition-colors duration-300"
                      >
                        {children}
                      </li>
                    ),
